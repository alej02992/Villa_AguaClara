...
/* ═══════════════════════════════════════
   ...
   Globales para poder usar onclick="..."
   ═══════════════════════════════════════ */
...
function toggleDecoracion() {
    ...
    if (btn) {
        ...
        if (calDecoActiva) btn.classList.add('activo');
...
function actualizarPrecio() {
    ...
    var detalle  = document.getElementById('cal-precio-detalle');
    ...
    if (detalle)    detalle.textContent    = noches + ' noche' + (noches > 1 ? 's' : '') + ' × ' + formatCOP(PRECIO_NOCHE);
...
function seleccionarDia(fecha) {
    ...
    if (btnWa) {
        if (calInicio && calFin) {
            ...
            var ciStr = calInicio.getDate() + ' ' + mesesCorto[calInicio.getMonth()] + ' ' + calInicio.getFullYear();
            var coStr = calFin.getDate()    + ' ' + mesesCorto[calFin.getMonth()]    + ' ' + calFin.getFullYear();
